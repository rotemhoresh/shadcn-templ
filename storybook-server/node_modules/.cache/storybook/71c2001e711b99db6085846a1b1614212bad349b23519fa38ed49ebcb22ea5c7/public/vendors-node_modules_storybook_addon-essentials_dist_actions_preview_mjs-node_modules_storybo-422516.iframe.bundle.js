(self["webpackChunkstorybook_server"] = self["webpackChunkstorybook_server"] || []).push([["vendors-node_modules_storybook_addon-essentials_dist_actions_preview_mjs-node_modules_storybo-422516"],{
...
var excludeTags=Object.entries(_storybook_global__WEBPACK_IMPORTED_MODULE_1__.global.TAGS_OPTIONS??{}).reduce((acc,entry)=>{let[tag,option]=entry;return option.excludeFromDocsStories&&(acc[tag]=!0),acc},{}),parameters={docs:{renderer:async()=>{let{DocsRenderer}=await Promise.all(/*! import() */[__webpack_require__.e("vendors-node_modules_storybook_addon-docs_dist_DocsRenderer-CFRXHY34_mjs"), __webpack_require__.e("node_modules_storybook_core_dist_components_sync_recursive-node_modules_storybook_core_dist_t-23f279")]).then(__webpack_require__.bind(__webpack_require__, /*! ./DocsRenderer-CFRXHY34.mjs */ "./node_modules/@storybook/addon-docs/dist/DocsRenderer-CFRXHY34.mjs"));return new DocsRenderer},stories:{filter:story=>(story.tags||[]).filter(tag=>excludeTags[tag]).length===0&&!story.parameters.docs?.disable}}};
...
/* harmony import */ var storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! storybook/internal/preview-api */ "storybook/internal/preview-api");
/* harmony import */ var storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _storybook_csf__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @storybook/csf */ "./node_modules/@storybook/csf/dist/index.mjs");
...
var PARAM_KEY="links";var{document,HTMLElement}=_storybook_global__WEBPACK_IMPORTED_MODULE_3__.global;var navigate=params=>storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1__.addons.getChannel().emit(storybook_internal_core_events__WEBPACK_IMPORTED_MODULE_0__.SELECT_STORY,params);var linksListener=e=>{let{target}=e;if(!(target instanceof HTMLElement))return;let element=target,{sbKind:kind,sbStory:story}=element.dataset;(kind||story)&&(e.preventDefault(),navigate({kind,story}));},hasListener=!1,on=()=>{hasListener||(hasListener=!0,document.addEventListener("click",linksListener));},off=()=>{hasListener&&(hasListener=!1,document.removeEventListener("click",linksListener));},withLinks=(0,storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1__.makeDecorator)({name:"withLinks",parameterName:PARAM_KEY,wrapper:(getStory,context)=>(on(),storybook_internal_preview_api__WEBPACK_IMPORTED_MODULE_1__.addons.getChannel().once(storybook_internal_core_events__WEBPACK_IMPORTED_MODULE_0__.STORY_CHANGED,off),getStory(context))});var decorators=[withLinks];
...
//# sourceMappingURL=vendors-node_modules_storybook_addon-essentials_dist_actions_preview_mjs-node_modules_storybo-422516.iframe.bundle.js.map